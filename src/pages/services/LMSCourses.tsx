...
const LMSCourses = () => {
  const benefits = [
    "Kajabi platform setup",
    "LearnDash configuration",
    "Kartra course management",
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="bg-background/90 backdrop-blur-sm p-8 rounded-lg space-y-6">
                ...
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Setup and support for Kajabi, LearnDash, Kartra, and ThriveCart to bring your programs to life.
                </p>
              </div>
            </div>
            <div className="flex justify-center">
              <div className="w-full max-w-md aspect-square bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center">
                <GraduationCap className="w-48 h-48 text-white/40" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-br from-primary/10 to-accent/10">
        <div className="container mx-auto max-w-4xl text-center space-y-8">
          ...
          <p className="text-xl text-muted-foreground">
            Let's build your learning platform and bring your expertise online.
          </p>
